...
INPUTDIR="/home/dcslab/git_rpr/rpr/traces/simmedium"
...
SIZE_radix=("27000" "54000" "81000" "108000" "135000" "162000" "189000" "216000" "243000" "270000")
...
INPUT=$INPUTDIR/${TARGET}_m.out
DATE=$(date '+%d%m%Y_%H%M%S')
echo "$DATE"
echo "$POLICY[*]"
echo "$NAME"

LOG=$LOG_DIR/${TARGET}_m.$NAME.$DATE.log
touch $LOG
